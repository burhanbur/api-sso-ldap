...
--
-- Name: applications applications_client_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: applications applications_client_secret_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.applications
    ADD CONSTRAINT applications_client_secret_key UNIQUE (client_secret);
